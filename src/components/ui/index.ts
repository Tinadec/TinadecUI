// TinadecUI — shadcn-style UI primitives (Ui*).
// Reused from TinadecOffice apps/desktop/src/components/ui (excludes the
// desktop-coupled `panel-style-control.vue`; `@/lib/utils` imports rewritten
// to `../../lib/utils`).

export { default as UiAlert } from './alert.vue'
export { default as UiAvatar } from './avatar.vue'
export { default as UiBackgroundPreview } from './background-preview.vue'
